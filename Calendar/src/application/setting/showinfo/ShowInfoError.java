package application.setting.showinfo;
...
public class ShowInfoError {

	public ShowInfoError(final String info, final String messengs, final String exceptionMessage) {
